...
export function RecommendationsScreen() {
  ...
  // its own height), then snaps fully open or fully closed on release — so
  // a small upward flick brings the search fields back without scrolling to
  // the top, and it never rests half-collapsed. It's clipped by the
  // wrapper's `overflow:'hidden'` so it can't bleed over the tabs above.
